...
if __name__ == "__main__":
    ...
    required.add_argument("-i", "--index", help="Fasta reference file", required=True)
    ...
    if args.out_dir is None:
        ...
        args.out_dir = os.path.join(args.read_dir, 'bwa_alignment')
    ...
    obj = bwa.BwaSEApocrita(extra_args=extra, **args.__dict__)
    obj.create_script()
    obj.submit()