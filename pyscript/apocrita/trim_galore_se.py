...
from pyscript import trim_galore
...
if __name__ == "__main__":
    ...
    if args.out_dir is None:
        ...
        args.out_dir = os.path.join(args.read_dir, 'trim_galore')
    ...
    obj = trim_galore.TrimGaloreSEApocrita(extra_args=extra, **args.__dict__)
    obj.create_script()
    obj.submit()