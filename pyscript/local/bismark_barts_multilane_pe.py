...
if __name__ == "__main__":
    ...
    required.add_argument("-i", "--index_dir", help="Directory of pre-computed Bismark index and fa files", required=True)
    ...
    obj = bismark.BismarkMultilanePEBash(extra_args=extra, **args.__dict__)
    obj.create_script()
    obj.submit()