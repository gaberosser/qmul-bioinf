...
Start with DMRForPairs. This requires us to specify two key parameters: $d_{\text{max}}$ is the maximum accepted distance between neighbouring probes for membership in a cluster and $n_{\text{min}}$ is the minimum number of probes in a cluster. We can tune these beforehand.
